 ...
 * software distributed under the License is distributed on anoe
...
public class TestClientByTime 
    implements AddCallback, ReadCallback{
    private static final Logger LOG = Logger.getLogger(TestClientByTime.class);
    ...
    public TestClientByTime() {
        entryId = 0;
        map = new HashMap<Integer, Integer>();
    }
    
    public TestClientByTime(String servers) throws KeeperException, IOException, InterruptedException{
        this();
    ...
    public TestClientByTime(String servers, int ensSize, int qSize)
    ...
    public TestClientByTime(FileOutputStream fStream)
    ...
    public static void main(String[] args) {
        ...
        case 0:           
            ...
            try {
                TestClientByTime c = new TestClientByTime(servers, Integer.parseInt(args[3]), Integer.parseInt(args[4]));
        ...
        case 1:
            ...
            try{
                TestClientByTime c = new TestClientByTime(new FileOutputStream(args[2]));
